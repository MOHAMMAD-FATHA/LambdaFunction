...
public class UserRegistration {
    ...
    public static void main(String[] args) {
        ...
        Validation FirstName = () -> {System.out.println("Enter first name :: ");String firstName = sc.next();return userReg.Name(firstName);};
        FirstName.validate();

        Validation LastName = () -> {System.out.println("Enter Last name :: ");String lastName = sc.next();return userReg.Name(lastName);};
        LastName.validate();

        Validation Email = () -> {System.out.println("Enter Email ID :: ");String EmailId = sc.next();return userReg.Email(EmailId);};
        Email.validate();

        Validation MobNum = () -> {System.out.println("Enter mobile number ::");String n = sc.next();return userReg.Number(n);};
        MobNum.validate();

        Validation Password = () ->{System.out.println("Please Enter password :: ");String password = sc.next();return userReg.password(password);};
        Password.validate();
    }
